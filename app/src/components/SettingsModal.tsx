    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-[#1e293b] rounded-xl border border-[#334155] w-[520px] animate-slide-in">
        ...
        <div className="p-4 space-y-4">
          <div>
            <label className="text-xs font-medium text-[#94a3b8] mb-1 block">{t.settings.claudeApiKey}</label>
            <input
              type="password"
              value={claudeKey}
          ...
          <div>
            <label className="text-xs font-medium text-[#94a3b8] mb-1 block">{t.settings.geminiApiKey}</label>
            <input
              type="password"
              value={geminiKey}
          ...
          <div>
            <label className="text-xs font-medium text-[#94a3b8] mb-1 block">{t.settings.customPromptLabel}</label>
            <textarea
              value={customPrompt}
